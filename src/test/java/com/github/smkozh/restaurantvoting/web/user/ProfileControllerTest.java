...
import static com.github.smkozh.restaurantvoting.web.user.ProfileController.REST_URL;
...
class ProfileControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        ...
        USER_MATCHER.assertMatch(userRepository.findAll(), List.of(admin, guest));
    }
